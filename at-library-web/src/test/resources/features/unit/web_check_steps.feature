...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопка|текст|элемент) "([^"]*)" отобразился на странице в течение (\d+) (?:секунд|секунды)
    И поле "ФИО" отображается на странице в течение 5 секунд
...
####################################################################################
  ...
  Сценарий: (?:кнопка|ссылка|поле|чекбокс|радиокнопка|текст|элемент) "([^"]*)" (?:недоступна|недоступно|недоступен) для нажатия
...
####################################################################################
  ...
  Сценарий: в поле "([^"]*)" содержится (\d+) символов
    И в поле "ФИО" введено значение "text.fio"
    Тогда текст поля "ФИО" содержит 20 символов
